...
$viewEmplist = "select id,vendor_id,latitude,longitude,city,state,country,pincode,registered_date from ps_latlong where vendor_status='0'";
                  ...
                  <div class="datatable">
                  	...
                  	foreach ($listReslt as $key => $listArr){ ?>
                                <tr>
                                   ...
                                   <td><a href="edit-vendor.php?formid=<?php echo base64_encode($listArr['vendor_id']);?>">Edit</a></td>
                                </tr>
							<?php $count++; } }else{ ?>
