                    ...
                    <div class="info-buttons">
                        <div class="col-lg-12">
                          ...
                          <div class="row block">
                            ...
                            <div class="col-md-2"><a href="bill-management.php"><i class="icon-cogs"></i>Bill Management<span></span></a></div>
							<div class="col-md-2"><a href="estore-management.php"><i class="icon-cart"></i>Estore Management<span></span></a></div>
                          </div>
                        </div>
                    </div>
                    <!-- /grid buttons -->
