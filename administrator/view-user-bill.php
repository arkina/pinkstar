...
$ObjCurd = new Curd();
if(isset($_REQUEST['bill'])){ $pid =base64_decode($_REQUEST['bill']);}
        ...
        <div class="page-content" style="min-height:500Px">
            ...
            <div class="page-header">
              <div class="page-title">
                <h3>Approved Bill<small>Welcome <?=ucfirst($_SESSION['username']);?> </small></h3>
              </div>
            </div>
         <!-- END PAGE HEAD-->
      ...
      <div class="col-lg-2">
        ...
        <div class="block">
            ...
            <div class="thumbnail">
              ...
              <div class="caption text-center">
                ...
                <div class="icons-group">
					...
					<a href="#" title="Facebook" class="tip"><i class="icon-facebook"></i></a> </div>
				  	<?php } ?>
				</div>
              </div>
            </div>
          ...
          <ul class="nav nav-list">
            ...
            <li><a href="view-user-bill?bill=<?=base64_encode("1"); ?>">Approved Bill <span class="label label-success">21</span></a></li>
            <li><a href="view-user-bill?bill=<?=base64_encode("2"); ?>">Pending Bill <span class="label label-danger">1</span></a></li>
            <li><a href="view-user-bill?bill=<?=base64_encode("3"); ?>">Rejected Bill <span class="label label-danger">2</span></a></li>
          </ul>
        </div>
        <!-- /profile links -->
      </div>
      <div class="col-lg-10">
        ...
        <div class="tabbable page-tabs">
          <ul class="nav nav-pills nav-justified">
            <li><a href="#activity" data-toggle="tab"><i class="icon-paragraph-justify2"></i> Activity</a></li>
