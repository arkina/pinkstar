...
$ObjCurd = new Curd();
$viewEmplist = "select location_id,name from ps_location where location_type=1 and parent_id='".$_REQUEST['pid']."' order by location_id ASC";
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                   ...
                   <ul class="breadcrumb-buttons collapse">
                    <li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="icon-plus"></i> <span>Add State</span> <b class="caret"></b></a>
                      <div class="popup dropdown-menu dropdown-menu-right">
                        ...
                        <form action="action/add-country.php" class="breadcrumb-search">
                          <input type="text" placeholder="State Name" name="name" class="form-control autocomplete">
						  <input type="hidden" name="add-states" value="add-states">
                    ...
                    <table class="table">
                  	...
                  	foreach ($listReslt as $key => $listArr){ ?>
                  		...
                  		if($keyval!="location_id"){ ?>
							...
							<?php } }?>
								<td><button class="btn btn-warning btn-icon" onclick="locationDel('stateDel',<?=$listArr['location_id'];?>,'view-cities')"><i class="icon-remove3"></i></button>
						...
						<a href="view-list-states.php?pid=<?=$_REQUEST['pid'];?>"><button class="btn btn-success btn-icon"><i class="icon-eye"></i></button></a>
								</td>
          ...
          <form class="form-horizontal" method='post' action="action/update-list-country.php">
          	<div class="form-group">
            	<div class="col-md-12">
					...
					<input type="hidden" name="states-list" value="states-list"/>
					<input type="hidden" id="pid" name="pid" value="<?php if(isset($_REQUEST['pid'])){ echo $_REQUEST['pid']; }?>"/>
                </div>
            </div>
