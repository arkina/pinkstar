    ...
    <div class="datatable">
      <table class="table">
        ...
        <tbody>
          <tr>
            <td>1</td>
            <td>Taranjeet Singh<br>Owner</td>
            <td>
                Mobile: 9876543210<br>
                Phone : 012365478<br>
                Alternate No. : 0123456987  or NA in case no alternate number
            </td>
            <td>info@taranjeetbindra.com</td>
            <td>23 Mar 2016 14:23</td>
            <td><button class="btn btn-success">Primary</button></td>
          </tr>
        </tbody>
      </table>
    </div>
...
<!-- button clases are success and the default 
          <?php  $count =1;
        ...
        <div class="row">
          <div class="col-md-6">
            <label>First Name</label>
             <input class="form-control" required name="first_name" id="first_name" value="<?php (isset($_POST['first_name']) ? $_POST['first_name'] : '');?>"/>
          </div>
          <div class="col-md-6">
            <label>Last Name</label>
             <input class="form-control" required name="last_name" id="last_name" value="<?php (isset($_POST['last_name']) ? $_POST['last_name'] : '');?>"/>
          </div>
        </div>
      </div>
      <div class="form-group">
        <div class="row">
          <div class="col-md-6">
            <label>Email Address</label>
             <input class="form-control" required name="email_id" id="email_id" value="<?php (isset($_POST['email_id']) ? $_POST['email_id'] : '');?>"/>
          </div>
          <div class="col-md-6">
      ...
      <div class="form-group">
        <div class="row">
          <div class="col-md-6">
            ...
            <input class="form-control" required name="phone" id="phone" value="<?php (isset($_POST['phone']) ? $_POST['phone'] : '');?>"/>
          </div>
          <div class="col-md-6">
            <label>Mobile Number</label>
            <input class="form-control" required name="mobile" maxlength="10" id="mobile" value="<?php (isset($_POST['mobile']) ? $_POST['mobile'] : '');?>"/>
          </div>
        </div>
      </div>
	<div class="form-group">
